...
## T-001 — Preparar build reproduzível e gate de testes [pendente]
...
## T-002 — Tornar configuração e migrações não destrutivas [pendente]
...
## T-003 — Proteger APIs e garantir posse/idempotência de revisão [pendente]
...
## T-004 — Endurecer uploads e armazenamento de imagens [pendente]
...
## T-005 — Isolar providers e limitar chamadas externas [pendente]
...
## T-006 — Criar avaliação determinística do RAG [pendente]
...
## T-007 — Documentar execução, segurança e operação [pendente]
