...
> gerado por `onp-spec plano` em 2026-08-18 18:56 — NÃO edite à mão;
...
|---|---|---|---|---|
| T-001 | Preparar build reproduzível e gate de testes | `gpt-5.6-terra` | high | `pom.xml`, `posture-service/pom.xml`, `.mvn/wrapper/maven-wrapper.properties`, `mvnw`, `mvnw.cmd`, `scripts/run-spec-tests.mjs`, `onpspec.config.json`, `.github/workflows/ci.yml`, `src/test/java/com/genai/java/spring/build/BuildContractTest.java` |
...
#### faixa-6 — branch `spec/production-hardening-faixa-6` — worktree `../onp-worktrees/project-java-spring-gen-ai-production-hardening-faixa-6`
...
#### faixa-7 — branch `spec/production-hardening-faixa-7` — worktree `../onp-worktrees/project-java-spring-gen-ai-production-hardening-faixa-7`

| tarefa | título | modelo | esforço | arquivos |
|---|---|---|---|---|
| T-007 | Documentar execução, segurança e operação | `gpt-5.6-terra` | medium | `README.md`, `gen-ai-with-java-spring.postman_collection.json`, `docker/dev/compose.yml`, `docker/dev/Dockerfile`, `docker/dev/posture-service.Dockerfile`, `src/test/java/com/genai/java/spring/docs/DocumentationContractTest.java` |
